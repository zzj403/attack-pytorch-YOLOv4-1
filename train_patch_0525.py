...
class PatchTrainer(object):
    ...
    def train(self):
        ...
        adv_patch_cpu = self.generate_patch("black")
        ...
        for epoch in range(n_epochs):
            ...
            ep_loss = 0
            bt0 = time.time()
            for i_batch, img_batch_name in tqdm(enumerate(train_loader), desc=f'Running epoch {epoch}',
                ...
                resize2 = transforms.Compose([
                    ...
                    transforms.Resize((self.darknet_model.height, self.darknet_model.width)),
                    transforms.ToTensor()])
                ...
                with autograd.detect_anomaly():
                    ...
                    boxes = do_detect(self.darknet_model, img_batch, 0.5, 0.4, use_cuda=True)
                    if len(boxes) == 0:
                        continue
                    ...
                    boxes2 = []
                    for box in boxes:
                        boxes2.append([box[6], box[0],box[1],box[2],box[3]])
