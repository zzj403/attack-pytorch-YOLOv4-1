...
def connected_domin_detect_and_score(input_img, max_total_area_rate, max_patch_number):
    ...
    for i in range(1, label_max_number + 1):
        ...
        img = transforms.ToPILImage()(now_count_map.detach().cpu())
        img.show()
...
def count_connected_domin_score_yolov4(max_total_area_rate, selected_path, max_patch_number, json_name, output_dir):
...
count_connected_domin_score_yolov4(0.02, 'train_pixel_attack', 10, '222.json', '')
...
def connected_domin_detect_and_score(input_img, max_total_area_rate, max_patch_number):
    ...
    area_score = min(2, float(max_total_area_rate/total_area_rate))
    return float(area_score), float(total_area_rate), float(label_max_number)
...
if __name__ == '__main__':
    ...
    selected_path = 'train_pixel_attack'
    max_patch_number = 10
